    ...
    <section className='mainSection createCharContainer'>
      ...
      <article className='card createChar'>
        ...
        <div className='createCharFields'>
          ...
          <div className='filmCheckboxContainer'>{filmCheckboxes}</div>
        </div>
        <div className='createCharButtonContainer'>
          ...
          <button type='button' className='btnMain' onClick={saveCharacter}>
            Save
          </button>
        </div>
      </article>
